...
public class OrdersController {
    ...
    CustomerOrder newOrder(@RequestBody NewOrderResource item) {
        try {
            ...
            LOG.info("Item address:" + item.address);
            LOG.info("Item customer:" + item.customer);
            LOG.info("Item card:" + item.card);
            LOG.info("Item items:" + item.items);
            ...
            LOG.info("Sending payment request to : " + config.getPaymentUri());
