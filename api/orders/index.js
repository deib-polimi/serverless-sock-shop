(function (){
  ...
  app.post("/orders", function(req, res, next) {
    ...
    console.log("Posting orders request received with body: " + JSON.stringify(req.body));
    var logged_in = req.cookies.logged_in;
    if (!logged_in) {
      throw new Error("User not logged in.");
      return
    ...
    async.waterfall([
        function (callback) {
          request(endpoints.customersUrl + "/" + custId, function (error, response, body) {
            ...
            try{
              ...
              callback("Error while retrieving customer");
              return;
            }
          });
        },
        ...
        function (order, callback) {
          ...
          console.log("Requesting Options " + options.uri)
