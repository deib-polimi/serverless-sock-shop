(function (){
  ...
  app.get("/cart", function (req, res, next) {
    ...
    request(endpoints.cartsGetUrl + "/" + custId + "/items", function (error, response, body) {
      if (error) {
        return next(error);
      }
  ...
  app.delete("/cart", function (req, res, next) {
    ...
    var options = {
      uri: endpoints.cartsDeleteUrl + "/" + custId,
      method: 'DELETE'
    };
  ...
  app.delete("/cart/:id", function (req, res, next) {
    ...
    var options = {
      uri: endpoints.cartsDeleteUrl + "/" + custId + "/items/" + req.params.id.toString(),
      method: 'DELETE'
    };
    request(options, function (error, response, body) {
      if (error) {
  ...
  app.post("/cart", function (req, res, next) {
    ...
    async.waterfall([
        ...
        function (item, callback) {
          var options = {
            uri: endpoints.cartsPostUrl + "/" + custId + "/items",
            method: 'POST',
            json: true,
